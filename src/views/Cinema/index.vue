    ...
    <div id="main">
        ...
        <div id="content">
			<div class="cinema_menu">
				<router-link tag="div" to="/cinema/ciList" class="city_switch">
...
.cinema_menu .city_switch.router-link-active{ color: #ef4238; }
.cinema_menu .brand_swtich.router-link-active{ color: #ef4238; }
.cinema_menu .feature_swtich.router-link-active{ color: #ef4238; }
</style>